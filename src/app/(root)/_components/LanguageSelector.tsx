...
function LanguageSelector() {
  ...
  // Get the current language and the function to update it from the store
  const { language, setLanguage } = useCodeEditorStore();
  const currentLanguageObj = LANGUAGE_CONFIG[language]; // give language as the key to get the current language config 
