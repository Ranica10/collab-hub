...
import RunCodeSkeleton from "./RunCodeSkeleton";
...
function OutputPanel() {
  ...
  // If there's no content to copy, do nothing
    if (!hasContent) return;

    // Copy the error or output to the clipboard
  ...
  return (
    <div className="relative bg-[#181825] rounded-xl p-4 ring-1 ring-gray-800/50">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {/* Copy Button (shows if content present) */}
        {hasContent && (
          <button
            onClick={handleCopy}
